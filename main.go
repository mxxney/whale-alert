...
const (
	...
	whaleAlertApiKey = "ZcHltVDiAELPiRC5AnUOVasgNkYbV7UQ" // Your Whale Alert API key
	iftttApiKey      = "https://maker.ifttt.com/trigger/whale_alerts/with/key/eE_DmS94IanDR4YBTSPOk0TSDlqRgfmEa0Dy8SQFOvA" // Your IFTTT API key
...
var (
    ...
    MinValueUSD: 10_000, // The minimum transaction value in USD to trigger an alert
}
